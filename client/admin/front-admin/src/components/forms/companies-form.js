            ...
            <form>
              <div class="tab-content active" data-tab="general">
                ...
                <div class="form-element">
                  ...
                  <input type="text" class="name-input" name="commercialName">
                </div>
                <div class="form-element">
                  <label>Nombre fiscal</label>
                  <input type="text" class="email-input" name="fiscalName">
                </div>
                <div class="form-element">
                  <label>Dirección comercial</label>
                  <input type="text" class="name-input" name="commercialAddress">
                </div>
                <div class="form-element">
                  <label>Dirección fiscal</label>
                  <input type="text" class="email-input" name="fiscalAddress">
                </div>
                <div class="form-element">
                  <label>CIF</label>
                  <input type="text" class="email-input" name="vatNumber">
                </div>
              </div>
            </form>
          </div>
