...
class ProductsForm extends HTMLElement {
            ...
            <form>
              <div class="tab-content active" data-tab="general">
                ...
                <div class="form-element">
                  ...
                  <select name="productCategoryId" class="category-input"></select>
                </div>
                <div class="form-element">
                  <label>Nombre</label>
                ...
                <div class="form-element">
                  ...
                  <input type="text" class="reference-input" name="reference">
                </div>
                <div class="form-element">
                  <label>Precio</label>
                  <input type="number" class="price-input" name="basePrice">
                </div>
                <div class="form-element">
                  <label>Unidades</label>
                  <input type="text" class="unit-input" name="units">
                </div>
                <div class="form-element">
                  <label>Unidad de Medida</label>
                  <select class="visibility-input" name="measurementUnit">
                ...
                <div class="form-element">
                  <label>Medida</label>
                  <input type="text" class="measurement-input" name="measurement">
                </div>
                <div class="form-element">
                  <label>Visible</label>
                  <select class="visibility-input" name="visible">
  ...
  async getProductCategories () {
    const categories = this.shadow.querySelector('.category-input')
