...
class CompaniesTable extends HTMLElement {
  ...
  render () {
    ...
    this.data.rows.forEach(element => {
      ...
      const listCommercialName = document.createElement('li')
      listCommercialName.textContent = `Nombre comercial: ${element.commercialName}`
      list.appendChild(listCommercialName)

      const listvatNumber = document.createElement('li')
      listvatNumber.textContent = `CIF: ${element.vatNumber}`
      list.appendChild(listvatNumber)
