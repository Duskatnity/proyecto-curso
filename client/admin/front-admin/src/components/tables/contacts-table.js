...
class ContactsTable extends HTMLElement {
  ...
  render () {
    ...
    this.data.rows.forEach(element => {
      ...
      listSubject.classList.add('subject')
      listSubject.textContent = `Subject: ${element.subject}`
      list.appendChild(listSubject)

      const listMessage = document.createElement('li')
      listMessage.classList.add('message')
      listMessage.textContent = `Message: ${element.message}`
